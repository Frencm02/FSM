...
{
    [TestClass]
    public class FSMPolledAndTimeoutTests
    {
        ...
        public void PolledFSMTest()
        {
            ...
            Assert.IsTrue(runningPolled);
            Assert.IsTrue(runningTimeout);
        }
        ...
        {
            runningPolled = true;
            Console.WriteLine("RunningPolledState");

        }
        public void FsmAction_RunningTimeout()
        {
            runningTimeout = true;
            Console.WriteLine("RunningTimeoutState");
